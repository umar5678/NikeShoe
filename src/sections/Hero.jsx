    ...
    return (
        <section id="home" className="w-full   p-2 flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container ">
            <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
                ...
                <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[48px] max-sm:leading-normal font-bold ">
            ...
            <div className="relative flex flex-1 justify-center items-center xl:min-h-screen max-xl:py-40 bg-primery bg-hero bg-cover bg-center">
                <img
                    src={bigShoeImg}
                    alt="Shoes"
                    width={610}
